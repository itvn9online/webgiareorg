...
<?php
WGR_add_css( 'public/css/ten_file.css', [
    'get_content' => 1,
    'preload' => 1,
    'cdn' => CDN_BASE_URL,
] );
// lấy mã CSS trả về thay vì echo luôn
WGR_get_add_css( 'public/css/ten_file.css', [
    'get_content' => 1,
    'preload' => 1,
    'cdn' => CDN_BASE_URL,
] );
...
<?php
WGR_add_js( 'public/javascript/ten_file.js', [
    'get_content' => 1,
    'preload' => 1,
    'cdn' => CDN_BASE_URL,
], [
...
WGR_get_add_js( 'public/javascript/ten_file.js', [
    'get_content' => 1,
    'preload' => 1,
    'cdn' => CDN_BASE_URL,
], [
