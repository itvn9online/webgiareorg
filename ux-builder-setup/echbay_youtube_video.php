...
function action_echbay_youtube_video( $atts ) {
    ...
    <div class="img-inner image-cover dark" style="padding-top:56.25%;"> <img width="800" height="450" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20800%20450%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://i3.ytimg.com/vi/' . $video_id . '/maxresdefault.jpg" class="lazy-load attachment-large size-large" alt="hoc-tieng-trung-o-phu-quoc-giao-tiep" loading="lazy" srcset="" data-srcset="https://i3.ytimg.com/vi/' . $video_id . '/maxresdefault.jpg 800w, https://img.youtube.com/vi/' . $video_id . '/0.jpg 300w, https://i3.ytimg.com/vi/' . $video_id . '/maxresdefault.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" />
    ...
    if ( $video_title != '' ) {
        $html = '<h4 class="echbay-flatsome-menu">' . $video_title . '</h4>' . $html;
    }
