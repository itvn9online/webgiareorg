...
<div id="wgr-for-duplicator" class="d-none">
    <button type="button" title="Hệ thống sẽ copy một sản phẩm tương tự sản phẩm này" class="btn btn-warning click-set-nhanban"><i class="fa fa-copy"></i> Nhân bản</button>
