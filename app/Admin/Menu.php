...
function WGR_create_admin_menu()
{
    ...
    add_submenu_page($parent_slug, 'Lịch sử sửa', 'Lịch sử sửa', 'publish_pages', 'eb-revisions', 'func_include_wgr_private_code');
...
{
    // $a = WGR_get_contents('https://raw.echbay.com/itvn9online/webgiareorg/main/changes.txt');
